...
export function istPreviousMonthKey(d: Date = new Date()): string {
  const key = istDateKey(d);
...
export function istMonthLongName(d: Date = new Date()): string {
...
export function istDayBoundsUtc(dateKey: string): { start: Date; endExclusive: Date } {
...
export function isLastDayOfMonthIST(d: Date = new Date()): boolean {
